...
uses UnDmconsulta, UnDmpdv, UnFrmpdv, UnFrmlocalizacliente;
...
begin
   ...
   If   editcodigo.Text <> '' then begin
	   ...
	   If dmconsulta.qyclientevendaCLI_CODIGO.AsString = '' then begin
        ...
        FRMLOCALIZACLIENTE:= TFRMLOCALIZACLIENTE.Create(Self);
        FRMLOCALIZACLIENTE.ShowModal;
      	editcodigo.SetFocus;
//        editcodigo.Clear;
...
End;
  ...
  with DMLOJA do
    ...
    TBDEBITO.Post;
                          ...
                          valorparcela:= StrToCurr(editvalorvenda.Text);
...
//BEGIN
  ...
  FRMPDV.EDT_Nome.Text:= FRMCADCREDIARIO.editnome.Text;
  Close ();
