...
uses UnDmconsulta, UnFrmpdv, UnDmpdv;

{$R *.dfm}

procedure TFRMLOCALIZARPRODUTO.DBGrid1DblClick(Sender: TObject);
begin
DMLOJA.TBESTOQUE.Locate('referencia',DMCONSULTA.qylocalizarproduto.FieldByName('referencia').AsString,[]);
Close;
end;
