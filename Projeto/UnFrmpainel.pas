...
begin
   ...
   frmpdv.TrataRetorno_NFCe(iRetorno);
   Application.MessageBox( Pchar('Código Erro/Aviso = ['+pchar(Trim(StrCodAvisoErro))+'] ' +  #13 +
                                 'Mensagem Erro/Aviso =['+pchar(Trim(StrMsgAvisoErro))+'] '), 'DarumaFramework Retorno do Método', mb_ok);
...
Application.MessageBox('Usuario não permitido!','Informação do Sistema',Mb_IconInformation);
