...
begin
    ...
    EDT_Justificativa.Text:= 'Cancelado pois haviam erros no documento.';
...
begin
 messagedlg('Justificativa não pode se nulo!',mtInformation,[mbok],0);
 EDT_Justificativa.SetFocus;
 exit;
end;
  ...
  begin
    Application.MessageBox('Cancelamento Efetuado com Sucesso!','Informação do Sistema',Mb_IconInformation);
    Close;
  end

  else
    Application.MessageBox('Não foi possivel efetuar o cancelamento da NFCE!','Informação do Sistema',Mb_IconInformation);
    exit;
